...
const generateBooleans = (tree: Array<Buffer>, elementCount: number, indices: Array<number>, options: proofOptions = defaultProofOptions): proof => {
...
const generateBits = (tree: Array<Buffer>, elemCount: number, indices: Array<number>, options: proofOptions = defaultProofOptions): proof => {
...
export const generate = (tree: Array<Buffer>, elemCount: number, indices: Array<number>, options: proofOptions = defaultProofOptions): proof => {
