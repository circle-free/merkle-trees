...
export const generate = (tree: Array<Buffer>, elementCount: number, options: treeOptions = defaultTreeOptions): { compactProof: Array<Buffer>, elementCount: number, decommitments: Array<Buffer> } => {
