...
import "../internal/calldata/bytes/sorted-hash/merkle-library.sol";
...
contract Merkle_Storage_Using_Internal_Lib_Calldata_Bytes_Sorted_Hash {
  ...
  function create(bytes[] calldata elements) external {
    root = Merkle_Library_ICBSH.create_from_many(elements);
  }

  function verify_size(uint256 size, bytes32 element_root) external view returns (bool) {
    return Merkle_Library_ICBSH.verify_size(root, size, element_root);
  }
  ...
  function use_one(
    ...
    require(Merkle_Library_ICBSH.element_exists(root, index, element, proof), "INVALID_ELEMENT");
  ...
  function use_many(bytes[] calldata elements, bytes32[] calldata proof) external {
    require(Merkle_Library_ICBSH.elements_exist(root, elements, proof), "INVALID_ELEMENTS");
  ...
  function update_one(
    ...
    root = Merkle_Library_ICBSH.try_update_one(root, index, element, update_element, proof);
  }
  ...
  function update_many(
    ...
    root = Merkle_Library_ICBSH.try_update_many(root, elements, updates_elements, proof);
  }

  function append_one(bytes calldata append_element, bytes32[] calldata proof) external {
    root = Merkle_Library_ICBSH.try_append_one(root, append_element, proof);
  }

  function append_many(bytes[] calldata append_elements, bytes32[] calldata proof) external {
    root = Merkle_Library_ICBSH.try_append_many(root, append_elements, proof);
  }
  ...
  function use_one_and_append_one(
    ...
    root = Merkle_Library_ICBSH.try_append_one_using_one(root, index, element, append_element, proof);
  }
  ...
  function use_one_and_append_many(
    ...
    root = Merkle_Library_ICBSH.try_append_many_using_one(root, index, element, append_elements, proof);
  }
  ...
  function use_many_and_append_one(
    ...
    root = Merkle_Library_ICBSH.try_append_one_using_many(root, elements, append_element, proof);
  }
  ...
  function use_many_and_append_many(
    ...
    root = Merkle_Library_ICBSH.try_append_many_using_many(root, elements, append_elements, proof);
  }
  ...
  function update_one_and_append_one(
    ...
    root = Merkle_Library_ICBSH.try_update_one_and_append_one(
      root,
      index,
      element,
      update_element,
  ...
  function update_one_and_append_many(
    ...
    root = Merkle_Library_ICBSH.try_update_one_and_append_many(
      root,
      index,
      element,
      update_element,
  ...
  function update_many_and_append_one(
    ...
    root = Merkle_Library_ICBSH.try_update_many_and_append_one(root, elements, update_elements, append_element, proof);
  }
  ...
  function update_many_and_append_many(
    ...
    root = Merkle_Library_ICBSH.try_update_many_and_append_many(
      root,
      elements,
      update_elements,
      append_elements,
