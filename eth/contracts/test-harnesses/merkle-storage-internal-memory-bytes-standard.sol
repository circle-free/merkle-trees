...
contract Merkle_Storage_Using_Internal_Lib_Memory_Bytes_Standard {
  ...
  function verify_indices(bytes[] calldata elements, bytes32[] calldata proof) public pure returns (uint256[] memory) {
  ...
  function use_one(
    ...
    require(Internal_Merkle_Library.element_exists_m(root, index, element, proof), "INVALID_ELEMENT");
  ...
  function update_one(
    ...
    root = Internal_Merkle_Library.try_update_one_m(root, index, element, update_element, proof);
  }
  ...
  function append_one(bytes memory append_element, bytes32[] calldata proof) public {
    root = Internal_Merkle_Library.try_append_one_m(root, append_element, proof);
  }
  ...
  function use_one_and_append_one(
    ...
    root = Internal_Merkle_Library.try_append_one_using_one_m(root, index, element, append_element, proof);
  }
  ...
  function use_many_and_append_one(
    ...
    root = Internal_Merkle_Library.try_append_one_using_many_m(root, elements, append_element, proof);
  }
  ...
  function update_one_and_append_one(
    ...
    root = Internal_Merkle_Library.try_update_one_and_append_one_m(
      root,
      index,
      element,
      update_element,
