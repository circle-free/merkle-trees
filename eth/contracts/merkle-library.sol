...
library Merkle_Library {
  ...
  function get_roots_from_single_proof_update(uint256 index, bytes32 element, bytes32 update_element, bytes32[] memory proof) internal pure returns (bytes32 hash, bytes32 update_hash) {
    ...
    while(proof_index > 0) {
      if ((index != upperBound) || (index & 1 == 1)) {
        ...
        hash = (index & 1 == 1)
          ? hash_node(element, hash)
          : hash_node(hash, element);

        update_hash = (index & 1 == 1)
          ? hash_node(element, update_hash)
          : hash_node(update_hash, element);
      }
  ...
  function get_indices_from_multi_proof(uint256 elements_count, bytes32 flags, bytes32 skips, bytes32 orders) internal pure returns (uint256[] memory indices) {
    indices = new uint256[](elements_count);
  ...
  function get_root_from_multi_proof(bytes32[] memory elements, bytes32[] memory proof) internal pure returns (bytes32 right) {
  ...
  function get_roots_from_multi_proof_update(bytes32[] memory elements, bytes32[] memory update_elements, bytes32[] memory proof) internal pure returns (bytes32 flags, bytes32 skips) {
    ...
    while (true) {
      ...
      if (flags & bit_check == bit_check) {
        scratch_2 = (read_index + 1) % update_element_count;

        hashes[write_index] = (orders & bit_check == bit_check)
          ? hash_node(hashes[scratch_2], hashes[read_index])
          : hash_node(hashes[read_index], hashes[scratch_2]);

        hashes[update_element_count + write_index] = (orders & bit_check == bit_check)
          ? hash_node(hashes[update_element_count + scratch_2], hashes[update_element_count + read_index])
          : hash_node(hashes[update_element_count + read_index], hashes[update_element_count + scratch_2]);
        ...
        hashes[update_element_count + write_index] = (orders & bit_check == bit_check)
          ? hash_node(hashes[update_element_count + read_index], scratch)
          : hash_node(scratch, hashes[update_element_count + read_index]);
  ...
  function get_roots_from_append_proof_multi_append(bytes32[] memory append_elements, bytes32[] memory proof) internal pure returns (bytes32 hash, bytes32) {
    ...
    // reuse append_elements_count variable here, since old one no longer needed (is now total)
  ...
  function get_new_root_from_append_proof_single_append(bytes32 append_element, bytes32[] memory proof) internal pure returns (bytes32 append_hash) {
    uint256 proof_index = bit_count_32(uint32(uint256(proof[0])));
  ...
  function get_append_proof_from_single_proof(uint256 index, bytes32 element, bytes32[] memory proof) internal pure returns (bytes32 hash, bytes32[] memory append_proof) {
    uint256 proof_index = proof.length - 1;
    hash = hash_node(bytes32(0), element);
    uint256 append_node_index = uint256(proof[0]);
    uint256 upperBound = append_node_index - 1;
  ...
  function get_append_proof_from_single_proof_update(uint256 index, bytes32 element, bytes32 update_element, bytes32[] memory proof) internal pure returns (bytes32 hash, bytes32[] memory append_proof) {
    uint256 proof_index = proof.length - 1;
    hash = hash_node(bytes32(0), element);
    ...
    while(proof_index > 0) {
      if (index != upperBound || (index & 1 == 1)) {
        ...
        update_hash = (index & 1 == 1)
          ? hash_node(scratch, update_hash)
          : hash_node(update_hash, scratch);
  ...
  function get_append_proof_from_multi_proof(bytes32[] memory elements, bytes32[] memory proof) internal pure returns (bytes32 flags, bytes32[] memory append_proof) {
  ...
  function get_append_proof_from_multi_proof_update(bytes32[] memory elements, bytes32[] memory update_elements, bytes32[] memory proof) internal pure returns (bytes32 bit_check, bytes32[] memory append_proof) {
    uint256 update_element_count = update_elements.length;
    require(elements.length == update_element_count, "LENGTH_MISMATCH");
    ...
    while (true) {
      if (skips & bit_check == bit_check) {
        if (flags & bit_check == bit_check) {
          ...
          require(append_proof_index == 2 || hashes[update_element_count << 1] == flags, "INVALID_PROOF");

          if (append_proof_index == 2) {
            append_proof[1] = hashes[update_element_count + read_index];
          }
  ...
  function try_update_one(bytes32 root, uint256 index, bytes32 element, bytes32 update_element, bytes32[] memory proof) internal pure returns (bytes32 new_element_root) {
  ...
  function try_update_many(bytes32 root, bytes32[] memory elements, bytes32[] memory update_elements, bytes32[] memory proof) internal pure returns (bytes32 new_element_root) {
    bytes32 total_element_count = proof[0];
  ...
  function try_append_one(bytes32 root, bytes32 append_element, bytes32[] memory proof) internal pure returns (bytes32 new_element_root) {
    bytes32 total_element_count = proof[0];
  ...
  function try_append_many(bytes32 root, bytes32[] memory append_elements, bytes32[] memory proof) internal pure returns (bytes32 new_element_root) {
    bytes32 total_element_count = proof[0];
  ...
  function try_append_one_using_one(bytes32 root, uint256 index, bytes32 element, bytes32 append_element, bytes32[] memory proof) internal pure returns (bytes32 element_root) {
    bytes32 total_element_count = proof[0];
  ...
  function try_append_many_using_one(bytes32 root, uint256 index, bytes32 element, bytes32[] memory append_elements, bytes32[] memory proof) internal pure returns (bytes32 element_root) {
    bytes32 total_element_count = proof[0];
  ...
  function try_append_one_using_many(bytes32 root, bytes32[] memory elements, bytes32 append_element, bytes32[] memory proof) internal pure returns (bytes32 element_root) {
    bytes32 total_element_count = proof[0];
  ...
  function try_append_many_using_many(bytes32 root, bytes32[] memory elements, bytes32[] memory append_elements, bytes32[] memory proof) internal pure returns (bytes32 element_root) {
    bytes32 total_element_count = proof[0];
  ...
  function try_update_one_and_append_one(bytes32 root, uint256 index, bytes32 element, bytes32 update_element, bytes32 append_element, bytes32[] memory proof) internal pure returns (bytes32 element_root) {
    bytes32 total_element_count = proof[0];
  ...
  function try_update_one_and_append_many(bytes32 root, uint256 index, bytes32 element, bytes32 update_element, bytes32[] memory append_elements, bytes32[] memory proof) internal pure returns (bytes32 element_root) {
    bytes32 total_element_count = proof[0];
  ...
  function try_update_many_and_append_one(bytes32 root, bytes32[] memory elements, bytes32[] memory update_elements, bytes32 append_element, bytes32[] memory proof) internal pure returns (bytes32 element_root) {
    bytes32 total_element_count = proof[0];
  ...
  function try_update_many_and_append_many(bytes32 root, bytes32[] memory elements, bytes32[] memory update_elements, bytes32[] memory append_elements, bytes32[] memory proof) internal pure returns (bytes32 element_root) {
    bytes32 total_element_count = proof[0];
