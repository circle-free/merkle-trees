...
library Merkle_Library_ICB32S {
  ...
  function get_indices(bytes32[] calldata elements, bytes32[] calldata proof) internal pure returns (uint256[] memory) {
  ...
  function create_from_many(bytes32[] calldata elements) internal pure returns (bytes32 new_element_root) {
